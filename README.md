...
*Sungkyunkwan University, Smart Factory Capstone Design Project, 2026*

- Proposes Z-score + LSTM Autoencoder dual-detection structure for pneumatic cylinder fault classification
- Targets 6-class fault diagnosis with F1-score ≥ 0.90 using only PLC-internal Δt feature
- Integrates workpiece anomaly detection via D/X register cross-validation
- Manuscript in preparation; outline completed

### Individual Literature Review & Implementation

**Reviewed Paper:** Zubieta, J. et al. "Step-time measurement: A scalable sub-cycle time defining methodology for anomaly detection and predictive maintenance in sequential production lines." *Journal of Manufacturing Systems*, 83, 2025. [https://doi.org/10.1016/j.jmsy.2025.08.011](https://doi.org/10.1016/j.jmsy.2025.08.011)

- Reviewed and presented the Step-time methodology (sub-cycle time measurement using GRAFCET/IEC 60848)
- Independently reimplemented the anomaly detection pipeline in Python based on the paper's methodology
- Delivered a presentation summarizing the paper's contributions and implementation results

**Reviewed Paper:** Wojtulewicz, A.; Chaber, P. "Industrial Robot Control System with a Predictive Maintenance Module Using IIoT Technology." *Sensors*, 25(4), 1154, 2025. [https://doi.org/10.3390/s25041154](https://doi.org/10.3390/s25041154)

- Reviewed PLC-based predictive maintenance system using IIoT/MQTT architecture
- Implemented the predictive maintenance logic in Python as a learning exercise
